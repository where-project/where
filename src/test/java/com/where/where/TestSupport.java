...
public class TestSupport {
    ...
    public static List<PlaceCategory> generateCategories() {
        return IntStream.range(0, 5).mapToObj(i ->
                new PlaceCategory((long) i,
                        new Place(), new Category())
    ...
    public static PlaceDto generatePlaceDto(Place place) {
        PlaceDto placeDto = new PlaceDto(1L,
                place.getWorkDays(),
                place.getWorkHours(),
                place.getPlaceName(),
    ...
    public static Score generateScore() {
        Score score = new Score(1L,
                3, 3, LocalDate.now(),
                new User("Onur", "Akkepenek"),
                new Place(1L,
                        "Cafe Onur",
                        "Pazartesi-Cuma",
                        "08:00-24:00",
    ...
    public static Score generateScore(CreateScoreRequest createScoreRequest) {
        Score score = new Score(1L,
                createScoreRequest.getVenueScore(),
                createScoreRequest.getCoronaScore(),
                createScoreRequest.getCreateDate(),
                new User("Onur", "Akkepenek"),
                new Place(1L,
                        "Cafe Onur",
                        "Pazartesi-Cuma",
    ...
    public static ScoreDto generateScoreDto(Score score) {
        ...
        ScoreDto scoreDto = new ScoreDto(score.getId(),
                score.getVenueScore(),
                score.getCoronaScore(),
                score.getCreateDate(),
    ...
    public static Comment generateComment(CreateCommentRequest createCommentRequest) {
        Comment comment = new Comment(1L,
                createCommentRequest.getCommentText(),
                createCommentRequest.getCreateDate(),
                new User("Onur", "Akkepenek"),
                new Place(1L,
                        "Cafe Onur",
                        "Pazartesi-Cuma",
